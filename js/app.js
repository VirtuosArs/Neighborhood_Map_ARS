...
var viewModel = {
  locations: [
    ...
    new MarkerInfo('Pritam Group Of Hotels', 19.016924,
      72.8459731),
    new MarkerInfo('Hotel Parklane', 19.0159105, 72.8428462),
    new MarkerInfo('Hotel New Shree Niwas', 19.0293736,
      72.8467218),
...
viewModel.search = ko.computed(function() {
  ...
  var searchCompare = ko.utils.compareArrays(self.locations, self
    .search);
